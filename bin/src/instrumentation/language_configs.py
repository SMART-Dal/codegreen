    ...
    def _get_default_python_config(self) -> LanguageConfig:
        ...
        return LanguageConfig(
            ...
            query_config={
                ...
                "deduplication_rules": {
                    "function_exit": {
                        "scope": "function",  # Group by function scope
                        "priority_order": ["keyword.return", "return"],  # Prefer explicit returns over generic returns
                        "max_per_function": 1  # Only one exit point per function
                    },
                    "function_enter": {
                        "scope": "function",
                        "priority_order": ["local.definition.function", "function"],
                        "max_per_function": 1
                    }
                }
            },
