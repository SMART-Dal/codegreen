...
- [Architecture Documentation](architecture/nemb-vs-v1.md) - Understanding NEMB architecture
- [CLI Reference](website/docs/user-guide/cli-reference.md) - Command-line options
- [Commands Reference](scripts/commands.txt) - Complete command guide
