...
private:
 ...
 std::cout << "\nTesting Measurement Coordinator...\n";
 ...
 std::cout << " No RAPL provider available, testing coordinator without providers\n";
 }
 ...
 auto provider = drivers::create_intel_rapl_provider();
 if (!provider) {
 std::cout << " No RAPL provider available, skipping accuracy test\n";
 return true;
 }
 ...
 std::cout << " Low power increase detected - may indicate measurement issue\n";
 } else {
 ...
 auto provider = drivers::create_intel_rapl_provider();
 if (!provider) {
 std::cout << " No RAPL provider available, skipping overhead test\n";
 return true;
 }
 ...
 std::cout << " High overhead detected: " << avg_time_us << " μs\n";
 } else {
