...
int main(int argc, char* argv[]) {
 ...
 std::cout << "[ok] NEMB energy measurement system initialized successfully!" << std::endl;
 ...
 if (meter.self_test()) {
 std::cout << "[ok] System self-test passed" << std::endl;
 } else {
 ...
 out_file.close();
 std::cout << "[ok] Instrumented code saved to: " << instrumented_path << std::endl;
 } else {
 ...
 std::cout << "Measurement completed with warnings" << std::endl;
 }
